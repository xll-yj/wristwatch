...
$('.subs .sea').click(function () {
  //获取输入框的内容
  var suval = $('.subs .con').val(); //得到输入的内容以后，跳转到对应的页面
...
function carousel() {
  ...
  var imgs = $('article img'); //图片数量

  var num = imgs.length; //当前下标

  var index = 0; //小圆点对应的ul---获取ul

  var ul = $('article ul'); //遍历图片,添加圆点
